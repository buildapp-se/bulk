...
/**
 * How to find each ingredient in a store: [search query, name regex, exclude regex?]. Regexes run on the product name
 * in lower case without accents (ö -> o), so one rule works for Willys products and ICA offers alike.
 * The cheapest match per kg or litre is the ingredient's price. scripts/prices.ts reads this and writes src/lib/prices.json.
 */
export const BUY: Record<IngrId, readonly [q: string, re: string, not?: string]> = {
  kycklingfile: ['kycklingfilé', 'kycklingfile|kyckling file|kycklingbrostfile', 'strimla|skiva|minut|lar|mage|marin|hund|grillad|rokt|panerad|pålägg|palagg'],
  notfars: ['nötfärs', '^notfars', 'eko'],
  blandfars: ['blandfärs', '^blandfars', 'eko'],
  flaskfars: ['fläskfärs', '^flaskfars', 'eko'],
  flaskkarre: ['fläskkarré', '^flaskkarre', 'skiva|marin|rokt|kotlett|gril|kebab'],
  lax: ['laxfilé', '^laxfile|^laxportion|^lax i bit|^laxfile i bit', 'gravad|rokt|marin|panerad|pinklax'],
  kikartor: ['kikärtor', '^kikartor', 'rostade|snack'],
  halloumi: ['halloumi', '^halloumi', 'fries|burg|hotp|port'],
  sojafars: ['vegofärs fryst', '^vegofars|^sojafars', 'formbar|biff|bullar'],
  linser: ['röda linser', 'roda linser|linser hela roda|linser roda', 'soppa|gryta|pasta'],
  ris: ['jasminris', '^jasminris', 'kokpase|mikro|fardig'],
  pasta: ['spaghetti', '^spaghetti', 'fullkorn|glutenfri|farsk|lins|bon|carbonara|bolognese'],
  bulgur: ['bulgur', '^bulgur|^grov bulgur', 'sallad|gryta'],
  matvete: ['matvete', '^matvete', 'sallad'],
  couscous: ['couscous', '^couscous', 'parl|sallad'],
  potatis: ['fast potatis', '^potatis fast', 'mos|klyft'],
  sotpotatis: ['sötpotatis', '^sotpotatis', 'fries|pommes|chips|fryst'],
  broccoli: ['broccoli', '^broccoli', 'soppa|gratang|mix'],
  paprika: ['paprika röd', '^paprika rod|^paprika mix|^paprika 3-pack', 'pulver|rostad|inlagd'],
  haricots: ['haricots verts', '^haricots verts'],
  vitkal: ['vitkål', '^vitkal', 'strimlad|sallad'],
  aubergine: ['aubergine', '^aubergine', 'grill|inlagd'],
  wokmix: ['wok bigpack', '^wok ', 'nudl|sas|krydda|olja|panna'],
  artmorot: ['morötter ärter', '^morotter arter|^arter morotter|^arter & morotter|^morotter & arter'],
  spenat: ['spenat fryst', 'spenat fryst|^bladspenat', 'stuvad|gratang|soppa|pannkak'],
  artor: ['ärter frysta', '^arter frysta|^arter svenska frysta|^grona arter', 'morot|sockerart'],
  ...
  tacokrydda: ['taco spice mix', 'taco.*(spice|krydd)|tacokrydda', 'fajita|burrito|3-pack'],
  teriyaki: ['teriyaki sauce', '^teriyaki (sauce|sas)|teriyakisas', 'marin'],
  bbq: ['bbq sauce', 'bbq (sauce|sas)|^grillsas', 'chips|krydda|marin'],
  krossade: ['krossade tomater', 'krossade tomater|tomater krossade|tomater finkrossade', 'eko|orter|vitlok|chili|basilika|smaksatt'],
  passerade: ['passerade tomater', 'passerade tomater|tomater passerade', 'eko|orter|vitlok|basilika'],
  tomatpure: ['tomatpuré', '^tomatpur', 'eko'],
  kokosmjolk: ['kokosmjölk', '^kokosmjolk', '(^|[^0-9])[3-9] ?%|light|latt|dryck|eko'],
  grädde: ['matlagnings grädde 15', '^matlagnings ?gradde.*15|^matgradde 15', 'laktosfri'],
  graddfil: ['gräddfil', '^graddfil', 'dip|laktosfri|latt'],
  rivenost: ['riven ost', '^(gratangost|ost) .*riven|riven ost', 'pizza|mozzarella|parm|tex'],
  parmesan: ['parmigiano', '^parmigiano|^parmesan', 'riven|hyvlad|chips|pasta|sas'],
  feta: ['fetaost', '^fetaost', 'tarnad|kryddad|oliv|paj|laktosfri'],
  tzatziki: ['tzatziki', '^tzatziki', 'krydda|dipmix'],
  yoghurt: ['turkisk yoghurt', '^turkisk yoghurt 10', 'dryck'],
  sesam: ['sesamfrön', '^sesamfro', 'bar'],
  soja: ['japansk soja', 'japansk soja|sojasas japansk|^soy sauce', 'lag salt|glutenfri'],
  ostronsas: ['oyster sauce', '^oyster sauce|^ostronsas', 'gluten'],
  sweetchili: ['sweet chili sauce', '^sweet chili (sauce|sas|thai)', 'less sugar'],
  pesto: ['pesto genovese', '^pesto genovese|^gron pesto', 'vegan'],
  soltorkade: ['soltorkade tomater', 'soltorkade tomater|tomater soltorkade'],
  coleslaw: ['coleslaw', '^coleslaw', 'texas'],
  sirap: ['ljus sirap', '^ljus sirap'],
  lingon: ['lingonsylt', '^lingonsylt', 'socker'],
  worcester: ['worcestershire', 'worcester'],
  apelsin: ['apelsinjuice', '^apelsinjuice', 'morot|nypressad|fruktkott'],
  gurka: ['gurka', '^gurka( import| sverige| klass)', 'mini|eko'],
  champinjoner: ['champinjoner', '^champinjoner klass|^champinjoner$', 'mini|skivade|hela'],
  gullok: ['gul lök', '^lok gul', 'eko'],
  kvarg: ['kvarg naturell', '^naturell kvarg|^kvarg naturell', 'vanilj|mild|laktosfri'],
  grekisk: ['grekisk yoghurt 0', '^naturell grekisk yoghurt 0|^grekisk yoghurt 0', ''],
  yoghurt3: ['naturell yoghurt 3', '^(mild )?naturell (mild )?yoghurt 3', 'laktosfri|eko'],
  kesella: ['kesella', 'kesella', 'vanilj|smak|jordgubb|hallon|blabar|citron|mango|mild'],
  lattcreme: ['crème fraiche lätt', '^creme fraiche latt', 'orter|chili|vitlok'],
  kokoslatt: ['coconut milk light', '^coconut milk light|^kokosmjolk (light|latt|[3-9]%)'],
  tahini: ['tahini', '^tahini'],
  pbpulver: ['jordnötspulver', 'jordnotspulver|peanut (butter )?powder|^pb2'],
  jordnotter: ['jordnötter rostade', '^jordnotter rostade', 'choklad|dragerade|chili'],
  gochujang: ['gochujang', '^gochujang', 'nudlar|chips'],
  chipotle: ['chipotle', 'chipotle.*adobo|adobo.*chipotle'],
  sriracha: ['sriracha', 'sriracha', 'chips|mayo|notter|popcorn'],
  honung: ['honung', '^honung', 'melon|pomelo|senap'],
  senap: ['senap', '^senap', 'dijon|grov|honung'],
  majsstarkelse: ['majsstärkelse', '^majsstarkelse'],
  philadelphia: ['philadelphia light', '^light 11%|philadelphia light', 'grasl|orter|vitlok|chili'],
  minifraiche: ['mini fraiche', 'mini ?fraiche|^minifraiche', 'brioche|smak|orter'],
  mildamat: ['milda', 'milda.*(latt|mat)', 'laktosfri'],
  lattmjolk: ['lättmjölk', '^lattmjolk', 'laktosfri|eko|choklad'],
  ajvar: ['ajvar', '^ajvar'],
  kebabsas: ['kebabsås', '^kebabsas', 'vitlok|vit'],
  hotsauce: ['hot sauce', 'hot sauce|redhot', 'wing'],
  ost: ['hushållsost mager', 'hushallsost mager|mager hushallsost', 'skivad|riven'],
};
