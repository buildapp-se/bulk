...
const KIT_LIST: readonly Omit<Kit, 'hue'>[] = [
  ...
  { id: 'kottfarssas', name: 'Köttfärssås', tagline: 'Tomat, timjan, balsamico', protein: ['notfars', 'blandfars'], carb: 'pasta', veg: 'broccoli', sauce: true, base: 'tomat',
  ...
  { id: 'chili', name: 'Chili con carne', tagline: 'Spiskummin, bönor, värme', protein: ['notfars', 'blandfars'], carb: 'ris', veg: 'paprika', sauce: true, base: 'tomat',
  ...
  { id: 'shepherd', name: "Shepherd's pie", tagline: 'Worcester, mos, ärtor', protein: ['notfars'], carb: 'mos', veg: 'artmorot', sauce: true, base: 'tomat',
  ...
  { id: 'moussaka', name: 'Moussaka', tagline: 'Tomat, kanel, feta', protein: ['notfars', 'blandfars'], carb: 'potatis', veg: 'aubergine', sauce: true, base: 'tomat',
  ...
  { id: 'keema', name: 'Keema matar', tagline: 'Garam masala, grädde, ärtor', protein: ['notfars', 'kyckling'], carb: 'ris', veg: 'artor', sauce: true, base: 'tomat',
  ...
  { id: 'shawarma', name: 'Shawarma', tagline: 'Kardemumma, spiskummin, tahini', protein: ['kyckling', 'kikartor'], carb: 'bulgur', veg: 'paprika', base: 'rub',
