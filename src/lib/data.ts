...
const INGR_ = {
  ...
  // Creamy light base (FIH cookbook pattern). Values from typical labels.
  ...
  grekisk: { name: 'Grekisk yoghurt 0 %', n: [57, 10, 4, 0.2], src: 'est', cat: 'mejeri', packs: [500, 1000] },
...
const KIT_LIST: readonly Omit<Kit, 'hue'>[] = [
  ...
  // Creamy kits adapted from "Mina favoriter" (FIH Creations). Dairy in off the heat.
  { id: 'currymango', name: 'Krämig curry mango', tagline: 'Curry, Philadelphia, soja', protein: ['kyckling'], carb: 'ris', veg: 'paprika', sauce: true,
  ...
  { id: 'marryme', name: 'Marry me', tagline: 'Soltorkat, vitlök, parmesan', protein: ['kyckling'], carb: 'pasta', veg: 'spenat', sauce: true,
  ...
  { id: 'ajvar', name: 'Krämig ajvar', tagline: 'Ajvar, vitlök, parmesan', protein: ['kyckling', 'notfars'], carb: 'pasta', veg: 'spenat', sauce: true,
  ...
  { id: 'kebab', name: 'Kebabgryta', tagline: 'Kebabkrydda, yoghurt, spenat', protein: ['kyckling'], carb: 'ris', veg: 'spenat', sauce: true,
  ...
  { id: 'philly', name: 'Philly cheese', tagline: 'Färs, paprika, krämig ost', protein: ['notfars'], carb: 'pasta', veg: 'paprika', sauce: true,
  ...
  { id: 'buffalo', name: 'Buffalo', tagline: 'Hot sauce, ost, rödlök', protein: ['kyckling'], carb: 'sotpotatis', veg: 'broccoli',
  ...
  { id: 'svampsas', name: 'Krämig svampsås', tagline: 'Kalvfond, dijon, champinjoner', protein: ['flaskkarre', 'notfars', 'kyckling'], carb: 'mos', veg: 'champinjoner', sauce: true,
  ...
  { id: 'burger', name: 'Cheeseburger', tagline: 'Ost, pickles, burgersås', protein: ['notfars'], carb: 'potatis', veg: 'broccoli',
